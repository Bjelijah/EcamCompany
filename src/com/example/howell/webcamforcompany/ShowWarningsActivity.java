	...
	class MyAdapter extends BaseExpandableListAdapter{
		...
		public View getGroupView(int groupPosition, boolean isExpanded, View groupView,
            ...
            case 6:groupHolder.groupIcon.setImageResource(R.drawable.icon_warning_7);
		           ...
		           break;
            case 7:groupHolder.groupIcon.setImageResource(R.drawable.icon_warning_8);
		           groupHolder.faultCount.setText(SystemReportStorage.getInstance().getSystemWarningStatistics().getTeardownNumber()+"");
		           break;
            case 8:groupHolder.groupIcon.setImageResource(R.drawable.icon_warning_9);
