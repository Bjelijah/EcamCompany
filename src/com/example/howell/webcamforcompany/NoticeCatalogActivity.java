	...
	class GetNoticeCatalogAdapter extends BaseAdapter implements OnClickListener{
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
			...
			case 1:
				...
				holder.picture1.setImageDrawable(getResources().getDrawable(R.drawable.empty_photo));
			...
			case 2:
				...
				holder.picture2.setImageDrawable(getResources().getDrawable(R.drawable.empty_photo));
				holder.picture3.setVisibility(View.GONE);
				holder.picture4.setVisibility(View.GONE);
				break;
			...
			case 3:
				...
				holder.picture3.setImageDrawable(getResources().getDrawable(R.drawable.empty_photo));
				holder.picture4.setVisibility(View.GONE);
				break;
			case 4:
				holder.picture1.setVisibility(View.VISIBLE);
				...
				holder.picture4.setImageDrawable(getResources().getDrawable(R.drawable.empty_photo));
				break;
			}
