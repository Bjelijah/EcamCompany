	...
	class SetNotificationAdapter extends BaseAdapter {
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	    	...
	    	if(isSubscribedList[position]){
	    		holder.imageBtn.setImageDrawable(getResources().getDrawable(R.drawable.set_notification_item_added));
	    	}else{
	    		holder.imageBtn.setImageDrawable(getResources().getDrawable(R.drawable.set_notification_item_add));
	    	}
...
//					adapter.notifyDataSetChanged();
	...
	public void onClick(View v) {
		...
		case R.id.set_notification_imagebutton:
			...
			ib.setImageDrawable(getResources().getDrawable(R.drawable.progress_blue));
			...
			new AsyncTask<Void, Integer, Void>(){
				...
				protected void onPostExecute(Void result) {
					...
					if(isSubscribedList[position]){
						ib.setImageDrawable(getResources().getDrawable(R.drawable.set_notification_item_add));
					}else{
						ib.setImageDrawable(getResources().getDrawable(R.drawable.set_notification_item_added));
					}
