...
public class EventTypeAdapter extends BaseAdapter {
	...
	public EventTypeAdapter(Context mContext ,List<String> list) {
		...
		this.list = list;
		icon1= mContext.getResources().getDrawable(R.drawable.event_type_io);
		icon2= mContext.getResources().getDrawable(R.drawable.event_type_vmd);
		icon3= mContext.getResources().getDrawable(R.drawable.event_type_videoloss);
		icon4= mContext.getResources().getDrawable(R.drawable.event_type_ircut);
		icon5= mContext.getResources().getDrawable(R.drawable.event_type_daynight);
		icon6= mContext.getResources().getDrawable(R.drawable.event_type_recordstate);
		icon7= mContext.getResources().getDrawable(R.drawable.event_type_storagemediumfail);
		icon8= mContext.getResources().getDrawable(R.drawable.event_type_radifailure);
		icon9= mContext.getResources().getDrawable(R.drawable.event_type_recordingfailure);
		icon10= mContext.getResources().getDrawable(R.drawable.event_type_badvideo);
		icon11= mContext.getResources().getDrawable(R.drawable.event_type_deviceself);
		icon12= mContext.getResources().getDrawable(R.drawable.event_type_maxconnections);
		icon13= mContext.getResources().getDrawable(R.drawable.event_type_networkbitrate);
		icon14= mContext.getResources().getDrawable(R.drawable.event_type_videobitrate);
		icon15= mContext.getResources().getDrawable(R.drawable.event_type_squint);
		icon16= mContext.getResources().getDrawable(R.drawable.event_type_videoturned);
		iconRight = mContext.getResources().getDrawable(R.drawable.qz_icon_forward_normal);
	}
